...
<main id="contenido">
    <div class="d-flex justify-content-center align-items-center vh-100">
        ...
        <div>
            ...
            <div class="row mb-3">
                <p class="col-4 mb-0">
                    <a href="index.php?ma=ingresar" class="btn btn-primary">Ingresar Materias</a>
                </p>
                <form action="" method="post" class="col-8 d-flex justify-content-center align-items-center">
                    ...
                    <a href="index.php?ma=indexBtn" name="btnLimpiar" class="btn btn-primary ms-2" value="limpiar">Restablecer</a>
                </form>
            </div>
