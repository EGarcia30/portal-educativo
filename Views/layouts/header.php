        ...
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="navbar-nav d-flex flex-column mt-5 ms-md-2 ms-0 ">
                <li class="nav-item w-100 mt-5">
                    <a href="index.php?a=index" class="nav-link">Alumnos</a>
                </li>
                <li class="nav-item w-100 mt-5">
                    <a href="index.php?ma=index" class="nav-link">Materias</a>
                </li>
                <li class="nav-itemw-100 mt-5">
                    <a href="index.php?i=index" class="nav-link">Inscripciones</a>
                </li>
                <li class="nav-item w-100 mt-5">
                    <a href="index.php?n=index" class="nav-link">Notas Finales</a>
                </li>
                <li class="nav-item w-100 mt-5">
